<template>
  <div class="flex items-start gap-2 rounded border p-2"
    ...
    <template v-if="mode === 'token'">
      <div class="w-20">
        <label class="text-xs text-gray-400">{{ t('common.min') }}</label>
      ...
      <div class="w-20">
        <label class="text-xs text-gray-400">{{ t('common.max') }} <span class="text-gray-300">({{ t('common.inclusive') }})</span></label>
