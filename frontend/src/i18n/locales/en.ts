export default {
  ...
  admin: {
    ...
    dataAnalysis: {
      title: 'Data Analysis',
      description: 'Analyze latency, time to first token, and error rate by account or group',
      dimension: 'Dimension',
      ...
      sortErrorRate: 'Highest error rate',
      sortDuration: 'Slowest avg response',
      sortTtft: 'Slowest avg TTFT',
      totalRequests: 'Total Requests',
      ...
      avgTtft: 'Avg TTFT',
      samples: 'samples',
      tableTitle: 'Account and Group Performance',
      noRange: 'No time range',
      rows: '{count} rows',
      empty: 'No data',
      requests: 'Requests',
      success: 'Success',
      tokens: 'Tokens',
      durationAvg: 'Resp Avg',
      durationMin: 'Resp Min',
      durationMax: 'Resp Max',
      durationP95: 'Resp P95',
      ttftAvg: 'TTFT Avg',
      ttftMin: 'TTFT Min',
      ttftMax: 'TTFT Max',
      ttftP95: 'TTFT P95',
      optionsLoadFailed: 'Failed to load filter options',
