...
import { APP_BRAND_NAME, normalizeBrandName } from '@/config/brand'
...
const siteName = ref<string>(APP_BRAND_NAME)
...
const registrationFormDisabled = computed(() => isLoading.value || !settingsLoaded.value)

const registrationActionDisabled = computed(
  () => registrationFormDisabled.value || agreementGateActive.value
)
...
onMounted(async () => {
  ...
  try {
    ...
    siteName.value = normalizeBrandName(settings.site_name)
